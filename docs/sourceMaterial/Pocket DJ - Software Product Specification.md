...
- **Web Specifics**:
  ...
  - **Chat/Real-time:** Socket.io or TalkJS (**_uncommitted: under future roadmap_**).
  ...
  - **Microfrontend Event Bus**: Shared lightweight event emitter for cross‑MFE events (TRACK_LOADED, PLAYLIST_UPDATED, etc.).
